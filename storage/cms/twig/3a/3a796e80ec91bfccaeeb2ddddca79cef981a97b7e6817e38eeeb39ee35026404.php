...
class __TwigTemplate_7a787ad1143838dac11b9fae9b49013ecbaae8584105944500c2f6cd9d573732 extends \Twig\Template
{
    ...
    ";
        ...
        <a class=\"text-xl font-bold text-indigo-800 cursor-pointer\" href=\"/company/";
            // line 4
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["company"], "id", [], "any", false, false, false, 4), "html", null, true);
            echo "\">
            ";
            // line 5
    ...
    {
        return array (  71 => 13,  61 => 9,  57 => 8,  51 => 5,  47 => 4,  44 => 3,  40 => 2,  37 => 1,);
    }
    ...
    <div class=\"border rounded p-2\">
        <a class=\"text-xl font-bold text-indigo-800 cursor-pointer\" href=\"/company/{{company.id}}\">
            {{company.name}}
        </a>
        <div class=\"flex text-gray-500 text-sm justify-between\">
